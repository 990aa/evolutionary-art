...
def test_phase3_stage_a_and_a_plus_b_on_grape() -> None:
    ...
    stage_a_lab = _lab_rmse(pre.target_rgb, stage_a_result.final_canvas)
    ...
    stage_ab_lab = _lab_rmse(pre.target_rgb, stage_ab_result.final_canvas)
    assert stage_ab_lab < 20.0
